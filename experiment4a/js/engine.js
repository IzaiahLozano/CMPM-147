...
function setup() {
  ...
  createP("Use arrow keys or WASD to scroll in the infinite world. Type whatever you want in the 'World key' to change the seed of the world. Click on any tile to plant a cotton candy tree.").parent("canvas-container");
